...
public class FilterTest extends AbstractIntegrationTest {
    ...
    public void createFilter() {
        ...
        filter = Filter.createIt("name", "A Filter", "client_id", client.getInteger("id"), "time_interval", 5, "retries", 3, "assigned_mailing_group_id", mailingGroup.getInteger("id"));
    ...
    public void getAssignableUsersReturnsAllUserForOnlyThatFilter() {
        Filter filter2 = Filter.createIt("name", "Another Filter", "client_id", client.getInteger("id"), "time_interval", 5, "retries", 3, "assigned_mailing_group_id", mailingGroup.getInteger("id"));
        PocUser pocUser2 = PocUser.createIt("client_id", client.getInteger("id"), "first_name", "Minnie", "last_name", "Mouse", "phone_number", "2222222222");
