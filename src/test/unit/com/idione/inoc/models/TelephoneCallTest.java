...
public class TelephoneCallTest extends AbstractIntegrationTest {
    ...
    public void createFilter() {
        ...
        Filter filter = Filter.createIt("name", "A Filter", "client_id", client.getInteger("id"), "time_interval", 5, "retries", 3, "assigned_mailing_group_id", mailingGroup.getInteger("id"));
